...
from processor.insurance_common.helper import TP_PREFFIX_HEX6
from processor.handler import InsuranceTransactionHandler
...
def main(args=None):
    ...
    try:
        ...
        handler = InsuranceTransactionHandler(TP_PREFFIX_HEX6)
