...
#     data_files.append(('/lib/systemd/system', ['packaging/systemd/sawtooth-healthcare-tp-python.service']))
#
...
setup(
    ...
    version='0.1',
    description='Sawtooth Insurance Processor Example',
    ...
    entry_points={
        'console_scripts': [
            ...
            'insurance-tp = processor.main:main',
        ]
    })
